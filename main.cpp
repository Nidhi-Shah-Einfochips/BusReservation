...
int main()
{
    ...
    BusIF::BusDetails details("BusId_1",stationlist1,5);
    BusIF::BusDetails details1("BusID_2",stationlist2,4);
    B1->AddBus(details);
    B1->AddBus(details1);
    std::cout<<"List of bus that go from src to des"<<std::endl;
    std::list <std::string> buslist;
    //buslist = B1->search((stationcode::stCode)0,(stationcode::stCode)3);
    std::cout<<B1->search((stationcode::stCode)0,(stationcode::stCode)3);
    //std::cout<<buslist;
    std::cout<<std::endl;
    return 0;
}
